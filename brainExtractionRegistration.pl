...
#
my $antsAICmd = "${antsPath}antsAI -d 3 -v 1 -m Mattes[$downsampleTemplate, $downsampleHeadImage, 32, Regular, 0.2] -t Similarity[0.1] -s [18, 0.2] -c 10 -g [40x40x40, 40] -o $initialAffine";
