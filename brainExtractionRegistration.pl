...
#
my $antsAICmd = "${antsPath}antsAI -d 3 -v 1 -m Mattes[$downsampleTemplate, $downsampleHeadImage, 32, Regular, 0.125] -t Similarity[0.1] -s [20, 0.12] -c 10 -g [0x40x40, 40] -o $initialAffine";
